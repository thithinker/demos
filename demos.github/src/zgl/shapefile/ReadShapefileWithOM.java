...
public class ReadShapefileWithOM {
	public static void main(String[] args) {
		...
		Map<String, Double[]> positions = readPointShp(pathShp, "主楼", 4);
	...
	/**
	 * 从点shapefile文件中读取点坐标数据
	 * @param path: 读取文件的路径，如"./buildPoint/buildPoint"，buildPoint为文件名
	 * @param name: 需要查找的位置名
	 * @param index: name在该shapefile文件中的列索引
	 * @return 
	 */
